...
<html lang="en" dir="ltr">
  ...
  <body>
    <table border="0" width="535px">
        ...
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 17px;">สำนักงานใหญ่ : {{@$dataComp->Company_Addr}}</p></td>
        </tr>
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 14px;"></p></td>
        </tr>
        <tr>
            <td width="210px" align="right"><p class="hideContent" style="font-size: 14px;">สัญญากู้ยืมเงินเลขที่</p></td>
            <td width="100px" align="center"><p style="font-size: 12px;"> <span class="fontTemp"><b>{{@$data->CONTNO}}</b></span></p></td>
            <td width="45px" align="center"><p class="hideContent" style="font-size: 20px;">เลขคุม</p></td>
        ...
        <tr>
            ...
            <td width="55px" align="center"><p class="hideContent" style="font-size: 14px;">วันที่</p></td>
            <td width="85px" align="right"><p style="font-size: 12px;"> <span class="fontTemp"><b>{{(@$data->SDATE != NULL)?date('d/m/Y', strtotime($data->SDATE . ' +543 years')):''}}</b></span></p></td>
            <td width="25px" align="center"><p class="hideContent" style="font-size: 14px;">เวลา</p></td>
            <td width="70px" align="center"><p style="font-size: 14px;"> <span class="fontTemp"><b></b></span></p></td>
        </tr>
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 10px;">sdsd</p></td>
        </tr>
    </table>
    @php 
    ...
    <table border="0" width="535px">
        <tr>
            <td width="535px" align="left" class="border-color" colspan="3" style="border-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-style: solid;"><h1 style="font-size: 16px;"><b class="hideContent"> สำหรับเจ้าหน้าที่</b></h1></td>
        </tr>
        <tr>
            ...
            <td width="50px" align="left"><p class="hideContent" style="font-size: 12px;">ปี</p></td>
        ...
        <tr>
            <td width="40px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> เลข</p></td>
            <td width="70px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$Asset->Vehicle_Engine}}</span></p></td>
            <td width="20px" align="left"><p class="hideContent" style="font-size: 12px;">ถัง</p></td>
        ...
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 12px;">sdsd</p></td>
        </tr>
        <tr>
            <td width="60px" align="right" style=""><p style="font-size: 12px;"> <span class="fontTemp">{{number_format(@$data->CAPITALBL,2)}}</span></p></td>
            <td width="17px" align="left" style=""><p class="hideContent" style="font-size: 12px;">บาท </p></td>
            <td width="45px" align="left" style=""><p class="hideContent" style="font-size: 12px;">เงินดาวน์</p></td>
            <td width="65px" align="center" style=""><p style="font-size: 12px;"> <span class="fontTemp">{{number_format(@$data->NDAWN,2)}}</span></p></td>
            <td width="17px" align="left" style=""><p class="hideContent" style="font-size: 12px;">บาท </p></td>
            <td width="50px" align="left" style=""><p class="hideContent" style="font-size: 12px;">ยอดจัด</p></td>
            <td width="60px" align="center" style=""><p style="font-size: 12px;"><span class="fontTemp">{{number_format(@$data->TCSHPRC,2)}}</span></p></td>
            <td width="17px" align="left" style=""><p class="hideContent" style="font-size: 12px;">บาท </p></td>
            <td width="70px" align="left" style=""><p class="hideContent" style="font-size: 12px;">ยอดสินเชื่อรวม</p></td>
            <td width="60px" align="center" style=""><p style="font-size: 12px;"><span class="fontTemp">{{number_format(@$data->TOTPRC,2)}}</span></p></td>
            <td width="17px" align="left" style=""><p class="hideContent" style="font-size: 12px;">บาท </p></td>
            <td width="45px" align="left"><p class="hideContent" style="font-size: 12px;">อัตราดอกเบี้ย</p></td>
        </tr>
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 6px;">sdsd</p></td>
        </tr>
        <tr>
            <td width="80px" align="right"><p style="font-size: 12px;"> <span class="fontTemp">{{number_format((@$data->Interest_IRR*12),2)}}</span></p></td>
            <td width="25px" align="left"><p class="hideContent" style="font-size: 12px;">%ต่อปี</p></td>
            <td width="65px" align="left"><p class="hideContent" style="font-size: 12px;">แบ่งชำระเป็น</p></td>
            ...
            <td width="10px" align="left"><p class="hideContent" style="font-size: 12px;">ค่า</p></td>
            ...
            <td width="68px" align="center" style="border-right-style: solid;"><p style="font-size: 12px;"><span class="fontTemp hideContent">{{(@$data->FDATE != NULL)?date('d/m/Y', strtotime(@$data->FDATE . ' +543 years')):''}}</span></p></td>
        </tr>
        <tr>
            <td width="90px" align="right" style="border-right-style: solid;"><p style="font-size: 12px;"><span class="fontTemp">{{(@$data->FDATE != NULL)?date('d/m/Y', strtotime(@$data->FDATE . ' +543 years')):''}}</span></p></td>
            <td width="25px" align="left"><p class="hideContent" style="font-size: 12px;">%ต่อปี</p></td>
        </tr>
        <tr>
            <td width="535px" align="left" colspan="3" style="border-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-style: solid;"><h1  style="font-size: 28px;"><b class="hideContent"> สำหรับลูกค้า</b></h1></td>
        </tr>
        <tr>
            ...
            <td width="40px" align="left"><p class="hideContent" style="font-size: 12px;">ชื่อเล่น</p></td>
        ...
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 4px;">sdsd</p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="535px" align="left" style="border-left-style: solid;border-top-style: solid;"><p class="hideContent" style="font-size: 26px;"> สถานภาพที่อยู่ปัจจุบัน</p></td>
        </tr>
        <tr>
            <td width="30px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;">ที่อยู่ปัจ</p></td>
            <td width="35px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$Address->houseNumber_Adds}}</span></p></td>
            <td width="95px" align="left" ><p class="hideContent" style="font-size: 12px;">หมู่ที่</p></td>
            <td width="50px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">ม.{{str_replace("ม.","",@$Address->houseGroup_Adds)}} บ้าน{{@$Address->village_Adds}}</span></p></td>
            <td width="65px" align="left"><p class="hideContent" style="font-size: 12px;">หมู่บ้าน/ร้าน/บริษัท</p></td>
            <td width="75px" align="left"><p style="font-size: 12px;"> <span class="hideContent fontTemp">ม.{{str_replace("ม.","",@$Address->houseGroup_Adds)}} บ้าน{{@$Address->village_Adds}}</span></p></td>
            ...
            <td width="20px" align="left"><p style="font-size: 12px;"><span class="fontTemp"></span></p></td>
            <td width="30px" align="left"><p class="hideContent" style="font-size: 12px;">ตำบล</p></td>
        ...
        <tr>
            <td width="535px" align="left" colspan="3"><p class="hideContent" style="font-size: 5px;">sdsd</p></td>
        </tr>
        <tr>
            <td width="20px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> เขต/อำเภอ</p></td>
            ...
            <td width="70px" align="left"><p class="hideContent" style="font-size: 12px;">รหัสไปรษณีย์</p></td>
            ...
            <td width="60px" align="left"><p class="hideContent" style="font-size: 12px;">มือถือ</p></td>
