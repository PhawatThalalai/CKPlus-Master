...
<html lang="en" dir="ltr">
  ...
  <body>
    <table border="0" width="535px">
        <tr>
            <td width="535px" align="left" colspan="3"><h1 class="hideContent" style="font-size: 12px;">{{@$dataComp->Company_Name}}</h1></td>
        </tr>
        <tr>
            <td width="400px" align="left" colspan="2"><p class="hideContent" style="font-size: 14px;">สำนักงานใหญ่ : {{@$dataComp->Company_Addr}}</p></td>
            <td width="135px" align="right"><p class="hideContent" style="font-size: 12px;"><b>คำเสนอค้ำประกันการกู้ยืม</b></p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="120px" align="right"><p style="font-size: 14px;"> <span class="fontTemp"><b>{{@$data->CONTNO}}</b></span></p></td>
        ...
        <tr>
            ...
            <td width="120px" align="center"><p style="font-size: 14px;"> <span class="fontTemp"><b>{{(@$data->SDATE != NULL)?date('d/m/Y', strtotime($data->SDATE . ' +543 years')):''}}</b></span></p></td>
    ...
    <table border="0" width="535px">
        ...
        <tr>
            <td width="120px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 13px;"> รายละเอียดหลักประกัน ยี่ห้อรถ</p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="60px" align="center" style="border-top-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp">{{number_format(@$data->CAPITALBL,2)}}</span></p></td>
        ...
        <tr>
            <td width="110px" align="right"><p style="font-size: 12px;"> <span class="fontTemp">{{number_format((@$data->Interest_IRR*12),2)}}</span></p></td>
            ...
            <td width="30px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{number_format(@$data->T_NOPAY,0)}}</span></p></td>
            ...
            <td width="80px" align="center" style="border-right-style: solid;"><p style="font-size: 12px;"><span class="fontTemp">0</span></p></td>
            <td width="140px" align="right"><p style="font-size: 12px;"> <span class="fontTemp">{{number_format(@$data->TOT_UPAY,2)}}</span></p></td>
        </tr>
        <tr>
            <td width="65px" align="left"><p class="hideContent" style="font-size: 12px;">ชำระงวดแรกวันที่</p></td>
            <td width="313px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"><span class="fontTemp">{{(@$data->FDATE != NULL)?date('d/m/Y', strtotime(@$data->FDATE . ' +543 years')):''}}</span></p></td>
        </tr>
        <tr>
            <td width="535px" align="left" colspan="3" style="border-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-style: solid;"><h1  style="font-size: 16px;"><b class="hideContent"> สำหรับผู้ค้ำประกัน</b></h1></td>
        </tr>
        @php 
        ...
        <tr>
            <td width="130px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> ความสัมพันธ์กับผู้กู้</p></td>
            <td width="100px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">พี่</span></p></td>
            <td width="130px" align="left"><p class="hideContent" style="font-size: 12px;"> ชื่อผู้กู้ นาย/นาง/น.ส./นิติบุคคล</p></td>
            <td width="175px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp">{{@$data->PactToCus->Prefix}}{{@$data->PactToCus->Name_Cus}}</span></p></td>
        </tr>
        <tr>
            <td width="140px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> ชื่อผู้ค้ำประกัน นาย/นาง/น.ส./นิติบุคคล</p></td>
            <td width="155px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$Guarantor1->Prefix}}{{@$Guarantor1->Name_Cus}}</span></p></td>
            <td width="30px" align="left"><p class="hideContent" style="font-size: 12px;">ชื่อเล่น</p></td>
            <td width="80px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$data->PactToCus->Nickname_cus}}</span></p></td>
            <td width="40px" align="left"><p class="hideContent" style="font-size: 12px;">ยศ (ถ้ามี)</p></td>
            <td width="90px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp"></span></p></td>
        </tr>
        <tr>
            ...
            <td width="120px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$Guarantor1->IDCard_cus}}</span></p></td>
        ...
        <tr>
            <td width="535px" align="left" colspan="3" style="border-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-style: solid;"><h1  style="font-size: 10px;"><b class="hideContent"> สำหรับผู้ค้ำประกัน</b></h1></td>
        </tr>
        <tr>
            <td width="60px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> บัตรหมดอายุ</p></td>
            <td width="65px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{(@$Guarantor1->IdcardExpire_cus != NULL)?date('d/m/Y', strtotime(@$Guarantor1->IdcardExpire_cus . ' +543 years')):''}}</span></p></td>
            <td width="110px" align="right" ><p class="hideContent" style="font-size: 12px;">วันเดือนปีเกิด/วันจดทะเบียน</p></td>
            <td width="80px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{(@$Guarantor1->Birthday_cus != NULL)?date('d/m/Y', strtotime(@$Guarantor1->Birthday_cus . ' +543 years')):''}}</span></p></td>
            <td width="20px" align="left"><p class="hideContent" style="font-size: 12px;">อายุ</p></td>
            <td width="30px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{calculateAge(@$Guarantor1->Birthday_cus)}}</span></p></td>
            <td width="10px" align="left"><p class="hideContent" style="font-size: 12px;">ปี</p></td>
            <td width="35px" align="left"><p class="hideContent" style="font-size: 12px;">สัญชาติ</p></td>
            <td width="25px" align="left"><p style="font-size: 12px;"><span class="fontTemp">{{@$Guarantor1->Nationality_cus}}</span></p></td>
            <td width="50px" align="left"><p class="hideContent" style="font-size: 12px;">วุฒิการศึกษา</p></td>
            <td width="50px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp"></span></p></td>
        </tr>
        <tr>
            ...
            <td width="45px" align="right"><p style="font-size: 12px;"> <span class="fontTemp">{{@$GuarantorAdds1->houseNumber_Adds}}</span></p></td>
            <td width="20px" align="left" ><p class="hideContent" style="font-size: 12px;">หมู่ที่</p></td>
            <td width="65px" align="left"><p class="hideContent" style="font-size: 12px;">หมู่บ้าน/ร้าน/บริษัท</p></td>
            <td width="75px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">ม.{{str_replace("ม.","",@$GuarantorAdds1->houseGroup_Adds)}} บ้าน{{@$GuarantorAdds1->village_Adds}}</span></p></td>
            ...
            <td width="55px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp">ต.{{@$Address->houseTambon_Adds}}</span></p></td>
        </tr>
        <tr>
            <td width="40px" align="left" style="border-left-style: solid;"><p class="hideContent" style="font-size: 12px;"> เขต/อำเภอ</p></td>
            <td width="60px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">อ.{{@$GuarantorAdds1->houseDistrict_Adds}}</span></p></td>
            <td width="25px" align="left" ><p class="hideContent" style="font-size: 12px;">จังหวัด</p></td>
            <td width="75px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">จ.{{@$GuarantorAdds1->houseProvince_Adds}}</span></p></td>
            <td width="45px" align="left"><p class="hideContent" style="font-size: 12px;">รหัสไปรษณีย์</p></td>
            <td width="45px" align="left"><p style="font-size: 12px;"> <span class="fontTemp">{{@$GuarantorAdds1->Postal_Adds}}</span></p></td>
            ...
            <td width="70px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp">{{substr(@$Guarantor1->Phone_cus,0,10)}}</span></p></td>
        </tr>
        <tr>
            ...
            <td width="155px" align="left" style="border-top-style: solid;"><p style="font-size: 12px;"><span class="fontTemp">{{@$Guarantor1->Mate_cus}}</span></p></td>
        ...
        <tr>
            ...
            <td width="95px" align="left"><p style="font-size: 12px;"> <span class="fontTemp"></span></p></td>
            <td width="25px" align="left"><p class="hideContent" style="font-size: 12px;">มือถือ</p></td>
            <td width="80px" align="left" style="border-right-style: solid;"><p style="font-size: 12px;"> <span class="fontTemp">{{substr(@$Guarantor1->Mate_Phone,0,10)}}</span></p></td>
        </tr>
        <tr>
