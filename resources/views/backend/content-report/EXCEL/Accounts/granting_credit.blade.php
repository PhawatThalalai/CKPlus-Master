...
if($tableLoan == 'PSL'){
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('J3', 'เงินต้น');
    $objPHPExcel->getActiveSheet()->setCellValue('K3', 'ดอกเบี้ย(บาท)');
    $objPHPExcel->getActiveSheet()->setCellValue('L3', 'ยอดผ่อนชำระ');
    $objPHPExcel->getActiveSheet()->setCellValue('M3', 'จำนวนงวด');
    $objPHPExcel->getActiveSheet()->setCellValue('N3', 'ค่างวดงวดละ');
    $objPHPExcel->getActiveSheet()->setCellValue('O3', 'จำนวนเดือนต่องวด');
    $objPHPExcel->getActiveSheet()->setCellValue('P3', 'EFF');
    $objPHPExcel->getActiveSheet()->setCellValue('Q3', 'Flat rate');
    ...
    foreach($data as $key=> $res){
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('J'.($row+1),  @$res->TCSHPRC );
        $objPHPExcel->getActiveSheet()->setCellValue('K'.($row+1),@$res->NETPROFIT);
        $objPHPExcel->getActiveSheet()->setCellValue('L'.($row+1),@$res->TOTPRC);
        $objPHPExcel->getActiveSheet()->setCellValue('M'.($row+1),@$res->T_NOPAY);
        $objPHPExcel->getActiveSheet()->setCellValue('N'.($row+1),@$res->TOT_UPAY);
        $objPHPExcel->getActiveSheet()->setCellValue('O'.($row+1),@$res->PERIOD);
        $objPHPExcel->getActiveSheet()->setCellValue('P'.($row+1),@$res->INTFLATRATE);
        $objPHPExcel->getActiveSheet()->setCellValue('Q'.($row+1),@$res->Interest_IRR);
