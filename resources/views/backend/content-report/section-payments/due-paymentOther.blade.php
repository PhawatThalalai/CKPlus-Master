		...
		<tbody>
			@foreach ($CHQTran as $key => $item)
				<tr>
					...
					<td align="right" colspan="2" class="spac-md">{{ number_format($item->NETPAY, 2) }}</td>
				</tr>
			@endforeach
		</tbody>
		<tfoot>
			<tr style="background-color: #FBE4D5">
				...
				<td colspan="2" align="center">{{ IntconvertThai($CHQMas->CHQAMT) }}</td>
