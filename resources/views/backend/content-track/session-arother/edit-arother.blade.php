...
<div class="modal-content">
	<div class="d-flex m-3">
		...
		<div class="flex-grow-1 overflow-hidden">
			<h5 class="text-primary fw-semibold font-size-15">แก้ไขลูกหนี้อื่น</h5>
			<p class="text-muted mt-n1 fw-semibold font-size-12">Bill no : {{ @$data->ARCONT}}</p>
			<p class="border-primary border-bottom mt-n2 m-2"></p>
            <input type="hidden" id="BILL" value="{{ @$data->ARCONT}}">
		</div>
	</div>
	<div class="modal-body">
		<form name="formUpdate" id="formUpdate" class="needs-validation" action="#" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <input type="hidden" name="id" value="{{@$data->id}}">
            <input type="hidden" id="loanType" name="loanType" value="{{@$data->PatchToPact->CodeLoan_Con}}">
			<div class="row mb-2">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="row g-2 align-self-center">
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="date" id="DateAdd" name="DateAdd" class="form-control" value="{{ @$data->ARDATE }}" placeholder=" " readonly>
								...
								<div class="col-sm-6 my-2">
                                    ...
                                    <div class="input-bx" id="datepicker1">
                                        <input type="text" name="DateAppoint" id="DateAppoint" value="{{ date('d/m/Y',strtotime(@$data->DDATE)) }}"
							...
							<div class="row g-2 align-self-center">
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="text" id="CONTNO" name="Contract" value="{{@$data->CONTNO}}" class="form-control" placeholder=" ">
                            ...
                            <div class="row mb-2">
								<div class="col-md-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" name="Note" id="Note" maxlength="10000" style="height: 100px">{{@$data->MEMO}}</textarea>
							...
							<div class="row g-2 align-self-center border-top">
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="text" id="PAYFOR_CODE" name="PayCode" value="{{@$data->PAYFOR}}" class="form-control PAYFOR_CODE" placeholder=" " required>
                                        <span>รหัสชำระ</span>
								...
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="text" id="PAYFOR_NAME" value="{{@$data->PAYCODE->FORDESC}}" class="form-control PAYFOR_NAME" placeholder=" ">
							...
							<div class="row g-2 align-self-center">
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="text" id="FOLLOWCODE" name="FollowCode" value="{{@$data->BILLCOLL}}" class="form-control" placeholder=" ">
                                        <span>ทีมติดตาม</span>
								...
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="text" type="text" id="FOLLOWNAME" value="{{@$data->ARBILLCOLL->name}}" class="form-control" placeholder=" ">
                            ...
                            <div class="row g-2 align-self-center">
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="number" id="AmountPaid" name="AmountPaid" value="{{@$data->PAYAMT}}" class="form-control" placeholder=" " required>
                                        <span>จำนวนเงิน</span>
								...
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="number" id="Discount" name="Discount" value="{{number_format(@$data->DISCOUNT,0)}}" class="form-control" placeholder=" ">
                                        <span>ส่วนลด</span>
                                        <button class="mx-0 btn btn-light border border-secondary border-opacity-50 font-size-10">บาท</button>
                                    </div>
								</div>
                            ...
                            <div class="row g-2 align-self-center">
								...
								<div class="col-sm-6 my-2">
                                    <div class="input-bx">
                                        <input type="number" id="TOT_SUM" name="TOT_SUM" value="{{@$data->BALANCE}}" class="form-control" placeholder=" ">
	...
	<div class="modal-footer">
		<button type="button" id="UpdateData" class="btn btn-primary btn-sm waves-effect waves-light w-md hover-up">
			<span class="addSpin"><i class="fas fa-download"></i></span> อัพเดท
		</button>
