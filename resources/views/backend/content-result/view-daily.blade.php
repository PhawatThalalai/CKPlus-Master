...
@section('datatrack2-p1-active', 'mm-active')
...
@section('content')
    ...
    <div class="card shadow-sm p-2">
        <div style="cursor: pointer; overflow: auto;  height: auto;" class="scroll-slide">
            <div id="container">
                @for ($i = 0; $i < 10; $i++) <div class="slide-content">
                            ...
                            <div class="d-flex flex-wrap mb-5">
                                ...
                                <div class="avatar-sm ms-auto">
                                    <div class="avatar-title bg-light rounded-circle text-primary font-size-20">
                                        ...
                                        <img src="{{ URL::asset('/assets/images/ck-logo.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
	...
	<div class="tab-content p-3 card">
		<div class="tab-pane active" id="all-order" role="tabpanel">
			<form id='filter-detail-daily'>
				<div class="row ">
					<input type="hidden" id="page" value="{{ $page }}" />
					<div class="col-xl col-sm-6">
						<div class="mb-2">
							<label class="form-label">ณ วันที่</label>
							<input type="text" value="{{ formatDateThai($todayformat) }}" class="form-control" readonly="true">
							<input type="hidden" name="DateHidden" id="DateHidden" value="{{ $todayformat }}" class="form-control" readonly="true">
						</div>
					</div>
					...
					<div class="col-xl col-sm-6">
						<div class="mb-2">
							...
							<select class="form-select addOPR" id="branch" name="branch" required>
								...
								@foreach ($branch->get() as $key => $item)
									{
					...
					<div class="col-xl col-sm-6 align-self-end">
						<div class="mb-2">
							<button type="button" class=" form-control form-icon-trailing btn btn-primary" id="searchDailyBtn">ค้นหาข้อมูล</button>
						</div>
					</div>
					<div class="col-xl col-sm-6 align-self-end">
						<div class="mb-2">
