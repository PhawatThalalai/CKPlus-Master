	...
	<div class="navbar-header">
		<div class="d-flex">
			...
			<div class="navbar-brand-box ">
				...
				@endphp
				<a href="{{ @$route }}?page={{ $iconRoute }}" class="logo logo-dark">
					<span class="logo-sm">
				...
				<a href="{{ @$route }}?page={{ $iconRoute }}" class="logo logo-light">
					<span class="logo-sm">
						<img src="{{ URL::asset('/assets/images/logo_ck.png') }}" alt="" height="30">
					</span>
					<span class="logo-lg">
			...
			<span class="app-search d-none d-lg-block" @style(['display: none !important;' => @$hideSearchTopbar == true])>
				...
				<div class="position-relative input-group">
					...
					<ul class="dropdown-menu dropdown-menu-end">
						...
						<li><a class="dropdown-item type-Select typ-phone {{ empty(@$dataSreach['phone']) ? 'd-none' : '' }}" value="phone">เบอร์โทรศัพท์</a></li>
					</ul>
										...
										<ul class="vstack gap-2">
											<li>
												...
												<ul class="sub-topbar-menu" aria-expanded="false">
													...
													<li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'config-take-document' }}&active={{ 'TAKE-DOC' }}">ประเภทการเบิกเอกสาร</a></li>
												</ul>
											</li>
											<li>
											...
											<li>
												<a href="#" class="title-topbar-menu">กำหนดกลุ่มงาน ( Into Groups )</a>
												<ul class="sub-topbar-menu" aria-expanded="false">
													<li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'constants' }}&module={{ 'data-groups' }}" class="">กำหนดกลุ่มสาขา</a></li>
													<li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'frontend' }}&set={{ 'data-intogroup' }}" class="">กำหนดเป้าสาขา</a></li>
												</ul>
											</li>
											<li>
												<a href="#" class="title-topbar-menu">กำหนดประเภทสัญญา ( Type Contracts )</a>
											</li>
										</ul>
									</div>
									<div class="col-md-3">
										...
										<ul class="vstack gap-2">
											...
											<li>
												<a href="{{ route('dataStatic.index') }}?page={{ 'backend' }}&set={{ 'data-payoth' }}" class="title-topbar-menu mb-1">ตั้งค่ารหัสชำระอื่นๆ ( PayOther Setting )</a>
											</li>
										</ul>
									</div>
									...
									@if (session()->get('h_page') == 'backend')
										<div class="col-md-3">
											...
											<ul class="vstack gap-2">
												...
												<li>
													<a href="{{ route('dataStatic.index') }}?page={{ 'backend' }}&set={{ 'data-gradecont' }}" key="t-text">กำหนดเกรดสัญญา ( Grade Contract )</a>
												</li>
											</ul>
										</div>
										<div class="col-md-3">
											...
											<ul class="vstack gap-2">
												<li>
													<a href="#" class="title-topbar-menu">กำหนดค่าคงที ( Generals )</a>
													<ul class="sub-topbar-menu" aria-expanded="false">
														<li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'backend' }}&set={{ 'data-track' }}">ค่าคงที งานบันทึกติดตาม </a></li>
														<!-- <li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'frontend' }}&set={{ 'data-general' }}&active={{ 'region' }}">ค่าคงที ภูมิภาค </a></li>
																<li class="mb-1 mt-1"><a href="{{ route('dataStatic.index') }}?page={{ 'frontend' }}&set={{ 'data-general' }}&active={{ 'ะฟเ' }}">ค่าคงที ติดตาม (tag)</a></li> -->
													</ul>
												</li>
										...
										<div class="col-md-3">
											<h5 class="font-size-14 mt-0 fw-semibold" key="t-ui-components">ส่วนลดปิดบัญชี</h5>
											<ul class="vstack gap-2">
												<li>
													<a href="{{ route('dataStatic.index') }}?page={{ 'backend' }}&set={{ 'data-dscratehp' }}" class="title-topbar-menu">ส่วนลดปิดบัญชีเช่าซื้อ</a>
												</li>
											</ul>
										</div>
									@endif
		...
		<div class="d-flex">
			...
			<div class="dropdown d-none d-lg-inline-block ms-1">
				...
				<a href="{{ @$route }}?page={{ $page }}" data-bs-trigger="hover focus" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="{{ $title }}">
