                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="input-bx mb-2">
                                            <input type="text" id="GROUPCAR" name="GROUPCAR" value="{{@$data->Group_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ" readonly/>
                                            <span>กลุ่มรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <select id="TYPECAR" name="TYPECAR" class="form-select text-dark" placeholder=" " data-bs-toggle="tooltip" title="ประเภทรถ" required>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="modal-body mt-n4">
                        <h5 class="text-primary fw-semibold text-center mb-3">รุ่น : {{(@$data != NULL)?@$data->yearToModelCar->Model_car:@$modelname}}</h5>
                                ...
                                <table class="table align-middle table-hover tbl_code_with_mark">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 20%;">
                                                <div class="input-bx mb-2">
                                                    <input type="number" id="YEARCAR" name="YEARCAR[]" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="ปีรถ" required/>
                                                    <span>ปีรถ</span>
                                                </div>
                                            </td>
                                            <td style="width: 35%;">
                                                <div class="input-bx mb-2">
                                                    <input type="number" id="PRICE_AT" name="PRICE_AT[]" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="Price AT"/>
                                                    <span>Price AT</span>
                                                </div>
                                            </td>
                                            <td style="width: 35%;">
                                                <div class="input-bx mb-2">
                                                    <input type="number" id="PRICE_MT" name="PRICE_MT[]" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="Price MT"/>
                                                    <span>Price MT</span>
                                                </div>
                                            </td>
                                            <td style="width: 10%;">
