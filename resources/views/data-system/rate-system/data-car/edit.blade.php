    ...
    <div class="modal-content">
        ...
        @if(@$edit == 'yearcar')
            <div class="card">
                ...
                <input type="hidden" name="MODEL_NAME" value="{{(@$data[0] != NULL)?@$data[0]->yearToModelCar->Model_car:@$modelname}}">
                <div class="card-body">
                    <div class="modal-body mt-n4">
                        <h5 class="text-primary fw-semibold text-center mb-3">รุ่น : {{(@$data != NULL)?@$data[0]->yearToModelCar->Model_car:@$modelname}}</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%;">
                                                    <div class="input-bx mb-2">
                                                        <input type="text" id="YEARCAR" name="YEARCAR[]" value="{{@$value->Year_car}}" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="ปีรถ"/>
                                                        <!-- <span>ปีรถ</span> -->
                                                    </div>
                                                </td>
                                                <td style="width: 25%;">
                                                    <div class="input-bx mb-2">
                                                        <input type="text" id="PRICE_AT" name="PRICE_AT[]" value="{{number_format(@$value->PriceAT_car)}}" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="Price AT"/>
                                                        <!-- <span>Price AT</span> -->
                                                    </div>
                                                </td>
                                                <td style="width: 25%;">
                                                    <div class="input-bx mb-2">
                                                        <input type="text" id="PRICE_MT" name="PRICE_MT[]" value="{{number_format(@$value->PriceMT_car)}}" class="form-control list" placeholder=" " data-bs-toggle="tooltip" title="Price MT"/>
                                                        <!-- <span>Price MT</span> -->
                                                    </div>
                                                </td>
        ...
        @elseif(@$edit == 'pricecar') 
            <div class="card">
                ...
                <input type="hidden" name="MODEL_NAME" value="{{@$data->yearToModelCar->Model_car}}">
                <div class="card-body">
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="text-center">
                                    <div class="mb-3 mt-n3">
                                        ...
                                        <img src="{{(@$data->Profile_car != NULL)?@$data->Profile_car:'assets/images/coming-soon.svg'}}" alt="" class="p-1 mb-2 rounded-circle border" style="width: 120px; height: 120px;">
                                    </div>
                                    <div class="d-flex justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="row mb-2">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="BRANDCAR" name="BRANDCAR" value="{{@$data->yearToBrandCar->Brand_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ" readonly/>
                                            <span>ยี่ห้อรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <input type="text" id="GROUPCAR" name="GROUPCAR" value="{{@$data->yearToGroupCar->Group_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ" readonly/>
                                            <span>กลุ่มรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <input type="text" id="MODELCAR" name="MODELCAR" value="{{@$data->yearToModelCar->Model_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="รุ่นรถ" readonly/>
                                            <span>รุ่นรถ</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-2 align-self-center border-top mb-2">
                                    <div class="col-6 col-md-6">
                                        ...
                                        <div class="input-bx mb-2">
                                            <input type="hidden" id="PRICE_AT_OLD" name="PRICE_AT_OLD" value="{{number_format(@$data->PriceAT_car)}}"/>
                                            <input type="text" id="PRICE_AT" name="PRICE_AT" value="{{number_format(@$data->PriceAT_car)}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="Price AT" required/>
                                            <span class="text-danger">Price AT</span>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="YEARCAR" name="YEARCAR" value="{{@$data->Year_car}}" class="form-control" data-bs-toggle="tooltip" title="ปีรถ" placeholder=" "/>
                                            <span>ปีรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <input type="hidden" id="PRICE_MT_OLD" name="PRICE_MT_OLD" value="{{number_format(@$data->PriceMT_car)}}"/>
                                            <input type="text" id="PRICE_MT" name="PRICE_MT" value="{{number_format(@$data->PriceMT_car)}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="Price MT" required/>
                                ...
                                <div class="row g-2 align-self-center border-top mb-2">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-0">
                                            <input type="text" id="PROFILE_CAR" name="PROFILE_CAR" value="{{@$data->Profile_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ"/>
                                            <span>ลิงค์โปรไฟล์รถ</span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="LINK_CAR" name="LINK_CAR" value="{{@$data->Link_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ"/>
            ...
            <script>
                $(document).ready(function(){
                    $('#TYPECAR').focus();
                    $('#TYPECAR').on('change', function (e){
                        let val = $(this).val();
                        if (val != '') {
                            $("#YEARCAR").focus();
                        }
                    });
                    $('#YEARCAR').on('keypress', function (e){
                        if (e.keyCode === 13 || e.which === 13) {
                            $("#PRICE_AT").focus();
                        }
                    });
                    $('#PRICE_AT').on('keypress', function (e){
                        if (e.keyCode === 13 || e.which === 13) {
                            $("#PRICE_MT").focus();
                        }
                    });
                    $('#PRICE_MT').on('keypress', function (e){
                        if (e.keyCode === 13 || e.which === 13) {
                            $("#UpdatePrice").focus();
                        }
                    });
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="row mb-2">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="BRANDCAR" name="BRANDCAR" value="{{@$data->modelToBrandCar->Brand_car}}" class="form-control" placeholder=" " readonly/>
                                            <span>ยี่ห้อรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <input type="text" id="GROUPCAR" name="GROUPCAR" value="{{@$data->modelToGroupCar->Group_car}}" class="form-control" placeholder=" " readonly/>
                                            <span>กลุ่มรถ</span>
                                        </div>
                                ...
                                <div class="row g-2 align-self-center border-top">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="MODELCAR" name="MODELCAR" value="{{@$data->Model_car}}" class="form-control" placeholder=" "/>
                                            <span>รุ่นรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <select id="TYPECAR" name="TYPECAR" class="form-select text-dark" placeholder=" ">
                                                <option value="">--- เลือกประเภทรถ ---</option>
                                                @foreach(@$carType as $key => $value)
                                                    <option value="{{$value->code_car}}" {{(@$data->Ratetype_id == $value->code_car)?'selected':''}}>{{$key+1}}. {{$value->nametype_car}}</option>
                                                @endforeach
                                        ...
                                        <div class="input-bx mb-2">
                                            <input type="text" id="TANKCAR" name="TANKCAR" value="{{@$data->Tank_No}}" class="form-control" placeholder=" "/>
                                            <span>เลขถัง</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="row mb-2">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="BRANDCAR" name="BRANDCAR" value="{{@$data->groupToBrandCar->Brand_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ" readonly/>
                                            <span>ยี่ห้อรถ</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-2 align-self-center border-top">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx mb-2">
                                            <input type="text" id="GROUPCAR" name="GROUPCAR" value="{{@$data->Group_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="กลุ่มรถ"/>
                                            <span>กลุ่มรถ</span>
                                        </div>
                                        <div class="input-bx mb-2">
                                            <select id="TYPECAR" name="TYPECAR"  class="form-select text-dark" placeholder=" " data-bs-toggle="tooltip" title="ประเภทรถ">
                                    ...
                                    <tbody>
                                        @foreach($data as $key => $value)
                                            <tr>
                                                ...
                                                <td style="width: 15%;">
                                                    <div class="input-bx mb-2">
                                                        <input type="text" id="PRICE_AT" name="PRICE_AT[]" value="{{number_format(@$value->PriceAT_car)}}" class="form-control border border-none" placeholder=" " data-bs-toggle="tooltip" title="Price AT"/>
                                                    </div>
                                                </td>
                                                <td style="width: 15%;">
                                                    <div class="input-bx mb-2">
                                                ...
                                                <td style="width: 15%;">
                                                    <div class="input-bx mb-2">
                                                        <input type="text" id="PRICE_MT" name="PRICE_MT[]" value="{{number_format(@$value->PriceMT_car)}}" class="form-control border border-none" placeholder=" " data-bs-toggle="tooltip" title="Price MT"/>
                                                    </div>
                                                    <input type="hidden" name="ID[]" value="{{@$value->id}}">
                                                </td>
                                            </tr>
        ...
        @elseif(@$edit == 'brandcar')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="input-bx">
                                            <input type="text" id="BRANDCAR" name="BRANDCAR" value="{{@$data->Brand_car}}" class="form-control" placeholder=" " data-bs-toggle="tooltip" title="ยี่ห้อรถ"/>
                                            <span>ยี่ห้อรถ</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer mt-n4">
                <button type="button" class="btn btn-danger DelBrand" data-id="{{@$data->id}}" data-name="{{@$data->Brand_car}}">
