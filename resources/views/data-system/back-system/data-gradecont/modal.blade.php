        ...
        <div class="modal-content">
            <div class="d-flex m-3 mb-0">
                ...
                <div class="flex-grow-1 overflow-hidden">
                    <h5 class="text-primary fw-semibold pt-2 font-size-15">เพิ่มเกรดสัญญา</h5>
                        ...
                        <div class="row">
                                ...
                                <div class="row g-2 mb-1">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" id="OVERDUE" name="OVERDUE" value="{{@$data->OVERDUE + 1}}" class="form-control" placeholder="OVERDUE" readonly>
                                            <label for="Contract">OVERDUE</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                                <div class="row g-2 mb-1">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" id="DEFAULT" name="DEFAULT" value="X" class="form-control" placeholder="DEFAULT" readonly>
                                            <label for="Contract">DEFAULT</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    if ($("#formAdd").valid() == true) {
        ...
        $.ajax({
            ...
            //   $(".loading-overlay").fadeOut().attr('style', 'display:none !important'); // ** ซ่อนตัวโหลด **
              ...
              $('#datagradecont').html(result).show('slow');
            }
        });
    }
    else{
