<div class="row">
    <div class="col-lg-12">
      <span class="showScroll2 float-end">
          <a class="Modal-xl hover-up" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.create') }}?page={{'backend'}}&modal={{'confLoan'}}&typeLoan={{ @$setpage === 'configPsl' ? 'PSL' : 'HP' }}&reqType={{'create'}}" style="cursor:pointer;">
  ...
  <div class="row">
      <div class="col-12">
          <div id="dataBranches">
              @include('data-system.back-system.data-confLoan.conf.data')
          </div>
      </div>
  </div>
