        ...
        <div class="modal-content">
            <div class="d-flex m-3 mb-0">
                ...
                <div class="flex-grow-1 overflow-hidden">
                    <h5 class="text-primary fw-semibold pt-2 font-size-15">เพิ่มรายการส่งมอบ</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="row g-2 mb-1">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" id="CODE" name="CODE" value="{{@$data->CODE}}" class="form-control" placeholder="รหัส" readonly>
                                            <label for="Contract">รหัส</label>
                                        </div>
                                    </div>
                                </div>
