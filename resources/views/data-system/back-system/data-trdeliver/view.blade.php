<div class="row">
  <div class="col-lg-12">
    <span class="showScroll2 float-end">
        <a class="Modal-xl hover-up" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.create') }}?page={{'backend'}}&modal={{'trdeliver'}}&mode={{'create'}}" style="cursor:pointer;">
...
<div class="row">
    <div class="col-12">
        <div id="dataCompanies">
            @include('data-system.back-system.data-trdeliver.data')
        </div>
    </div> <!-- end col -->
</div>
