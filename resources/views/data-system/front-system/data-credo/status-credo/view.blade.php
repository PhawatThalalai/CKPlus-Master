<div class="row">
    <div class="col-lg-12">
        <span class="showScroll2 float-end">
            <a class="Modal-xl hover-up" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.create') }}?page={{'frontend'}}&modal={{'status-credo'}}&mode={{'create'}}" style="cursor:pointer;">
            ...
            <!-- <div class="card-body"> -->
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        <h5 class="text-primary fw-semibold pt-2 font-size-15">จัดการ Credo ( Status Credo )</h5>
                    ...
                    <table class="table align-middle table-nowrap table-hover">
                        <thead class="table-light sticky-top">
                            <tr>
                                ...
                                <th scope="col">รหัส Credo</th>
                                <th scope="col">ชื่อ Credo</th>
                        ...
                        <tbody>
                            @foreach($data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1">{{@$value->Code_Credo}}</h5>
                                        <!-- <p class="text-muted mb-0">UI/UX Designer</p> -->
                                    </td>
                                    <td>{{@$value->Name_Credo}}</td>
                                    <td>
                                        <div>
                                            <a href="javascript: void(0);" class="badge badge-soft-primary font-size-11 m-1">{{@$value->Flag_Credo}}</a>
                                        </div>
                                    </td>
                                    <td>
                                        {{@$value->Date_Credo}}
                                    ...
                                    <td>
                                        <ul class="list-inline font-size-20 contact-links mb-0">
                                            <li class="list-inline-item px-2">
                                                <a class="dropdown-item edit-details Modal-xl" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.edit', $value->id) }}?page={{'frontend'}}&modal={{'status-credo'}}&mode={{'edit'}}" style="cursor:pointer;">
