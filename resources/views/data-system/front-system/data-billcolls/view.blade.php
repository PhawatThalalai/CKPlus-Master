<div class="row">
  <div class="col-lg-12">
    <span class="showScroll2 float-end">
        <a class="Modal-xl hover-up" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.create') }}?page={{'frontend'}}&modal={{'billcolls'}}&mode={{'create'}}" style="cursor:pointer;">
...
<div class="row">
    <div class="col-12">
        <div id="dataBillcolls">
            @include('data-system.front-system.data-billcolls.data')
        </div>
    </div>
</div>
