<div class="row">
  <div class="col-lg-12">
    <span class="showScroll2 float-end">
        <a class="Modal-xl hover-up" data-bs-toggle="modal" data-bs-target="#Modal-xl" data-link="{{ route('dataStatic.create') }}?page={{'frontend'}}&modal={{'bank'}}&mode={{'create'}}" style="cursor:pointer;">
...
<div class="row">
    <div class="col-12">
        <div id="dataBanks">
            @include('data-system.front-system.data-banks.data')
        </div>
    </div> <!-- end col -->
</div>
