<div class="card p-2 h-100">
    <div class="d-flex">
        ...
        <div class="flex-grow-1 overflow-hidden">
            <h5 class="text-primary fw-semibold pt-2 font-size-15">จัดการสาขา ( Branches Management )</h5>
        ...
        <table class="table align-middle table-nowrap table-hover">
            <thead class="table-light sticky-top">
                <tr>
                    ...
                    <th scope="col">รหัสสาขา2</th>
                    <th scope="col">ชื่อสาขา TH</th>
                    <th scope="col">ชื่อสาขา EN</th>
            ...
            <tbody>
                @foreach($data as $key => $value)
                    <tr>
                        ...
                        <td>{{@$value->id_Contract}}</td>
                        <td>-</td>
                        <td>
                            <p class="text-muted mb-0">{{@$value->Name_Branch}}</p>
                        </td>
                        <td>
                            <p class="text-muted mb-0">{{@$value->NickName_Branch}}</p>
                        </td>
                        <td>
                            <p class="text-muted mb-0">{{@$value->Branch_Active}}</p>
                        </td>
                        <td>
