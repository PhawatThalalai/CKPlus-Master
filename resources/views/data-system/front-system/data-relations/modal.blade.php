        ...
        <div class="modal-content">
            <div class="d-flex m-3 mb-0">
                ...
                <div class="flex-grow-1 overflow-hidden">
                    <h5 class="text-primary fw-semibold pt-2 font-size-15">เพิ่มความสัมพันธ์</h5>
                                ...
                                <div class="row g-2 mb-2">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" id="NAME_RELATION" name="NAME_RELATION" class="form-control" placeholder="ชื่อความสัมพันธ์" required>
                                            <label for="Contract">ชื่อความสัมพันธ์</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mt-4 mt-lg-0">
                                            <h5 class="font-size-12">เปิดปิด ความสัมพันธ์</h5>
                                            <div class="d-flex">
    ...
    <form name="formUp" id="formUp" action="#" method="post" enctype="multipart/form-data" novalidate style="font-family: 'Prompt', sans-serif;">
        ...
        <div class="modal-content">
            <div class="d-flex m-3 mb-0">
                ...
                <div class="flex-grow-1 overflow-hidden">
                    <h5 class="text-primary fw-semibold pt-2 font-size-15">เเก้ไขความสัมพันธ์</h5>
                    <h6 class="text-secondary fw-semibold font-size-12"><i class="bx bxs-map me-1"></i>{{@$page}}</h6>
                    <p class="border-primary border-bottom mt-2"></p>
                </div>
                <input type="hidden" id="page" value="{{@$page}}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-2 mb-2">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" id="NAME_RELATION" name="NAME_RELATION" value="{{@$data->Name_Rela}}" class="form-control" placeholder="ความสัมพันธ์" required>
                                            <label for="Contract">ความสัมพันธ์</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mt-4 mt-lg-0">
                                            <h5 class="font-size-12 mb-1">เปิดปิด ความสัมพันธ์</h5>
                                            <div class="d-flex">
                                                <div class="square-switch">
                                                    <input type="checkbox" id="square-switch3" switch="bool" name="FLAG" value="yes" {{(@$data->Flag_Rela == 'yes')?'checked':''}}>
                                                    <label for="square-switch3" data-on-label="Yes" data-off-label="No"></label>
                                                </div>
                                            </div>
                                        </div>
