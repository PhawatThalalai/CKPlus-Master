      ...
      <body class="body">
        ...
        <div class="page_break">
          ...
          <table border="0" style="width: 100%" >
            <tbody>
              <tr align="" >
                <td style="line-height: 4cm">&nbsp;</td>
                <td >

              </td>
              </tr>
              <tr align="">
                <td colspan="2"><span style="margin-left : 60px;" class="fontBl2">
                          {{ $DataCus->Name_Cus }} โทรศัพท์ {{ formatPhone(@$DataCus->Phone_cus) }}
                </span>
              </td>
              </tr>
              <tr align="" >
                ...
                <td >
                      <span class="fontBl2"> @php echo $cusAdd;  @endphp</span>
              </td>
              </tr>
          ...
          <table border="0" style="width: 50%" >
            <tbody>
              ...
              <tr align="">
                ...
                <td ><span  class="fontBl">
                          {{ $LoanCom->Company_Name }}
                </span><br/>
                <span class="fontBl">โทรศัพท์ {{ formatPhone(@$LoanCom->Company_Tel) }} </span>
              </td>
              </tr>
              <tr align="" >
                <td style="width:30px"></td>
                <td  align="left">
                      <span class="fontBl"> @php echo $LoanCom->Company_Addr;  @endphp</span>
              </td>
              </tr>
