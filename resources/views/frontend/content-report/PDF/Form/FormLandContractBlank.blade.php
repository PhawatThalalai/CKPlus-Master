      ...
      <body class="body">
        ...
        <table border="0" style="width: 100%" >
          <tbody>
            ...
            <tr align="" >
              <td colspan="2"style="height: 3.8cm">
                <span class="fontBl" style="margin: 10cm">
                  @php
            ...
            <tr align="" style="line-height:0.4cm">
              <td colspan="2" style="text-indent: 70px;"><span class="fontBl" style="margin-left : 380px;">{{ $ConFinance->Timelack_Car }}</span>
                   ...
                   <span class="fontBl" style="margin-left : 200px;"> {{$dateDue[0]}}</span>
                  <span class="fontBl" style="margin-left : 40px;">{{$dateDue[1]}}</span>
                  <span class="fontBl" style="margin-left :40px;"> {{$dateDue[2] }}</span>

                <br> <span class="fontBl"  style="margin-left : 120px;">{{ @$data->DateDue_Con != NULL ? date_format(date_create(@$data->DateDue_Con),'d') : ' ' }}</span> </td>
            </tr>
            <tr align="">
