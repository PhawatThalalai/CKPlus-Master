        ...
        {{-- <table border="0" style="width: 100%" >
          <tbody>
            ...
            <tr align=""style="height:0.5cm">
              ...
              <td colspan="2"><span class="fontBl" style="margin-left : 520px;">{{$dateCon[0]}}</span>
                <span class="fontBl" style="margin-left : 40px;">{{$dateCon[1]}}</span>
                <span class="fontBl" style="margin-left :40px;"> {{$dateCon[2] }}</span></td>
            </tr>
            <tr align="" style="line-height:0.4cm">
              <td   colspan="2"><span > <span class="fontBl" style="margin-left : 170px;">{{ @$DataCus->Name_Cus }}</span>
                <span class="fontBl" style="margin-left : 190px;">{{ @$CusAge->y }}</span>
            ...
            <tr align="" >
              <td colspan="2"style="height: 2.2cm"><span class="fontBl" style="margin: 25cm"> @if( @$data->ContractToCal->Buy_PA == "Yes" && @$data->ContractToCal->Include_PA == "Yes" )
              ...
              @else
                ...
                {{number_format((floatval(@$data->ContractToCal->Cash_Car)+floatval(@$data->ContractToCal->Process_Car)+floatval(@$data->ContractToCal->Insurance)+floatval(@$data->ContractToCal->Insurance_PA)),2)}}
              @endif</span>
              <span class="fontBl" >{{ IntconvertThai((floatval(@$data->ContractToCal->Cash_Car)+floatval(@$data->ContractToCal->Process_Car)+floatval(@$data->ContractToCal->Insurance)+floatval(@$data->ContractToCal->Insurance_PA))) }}</span> </td>
            </tr>
            ...
            <tr align="" style="line-height:0.4cm">
              <td colspan="2" style="text-indent: 70px;"><span class="fontBl" style="margin-left : 380px;">{{ @$ConFinance->Timelack_Car }}</span>
                   ...
                   <span class="fontBl" style="margin-left : 290px;"> {{$dateDue[0]}}</span>
                  <span class="fontBl" style="margin-left : 40px;">{{$dateDue[1]}}</span>
                  <span class="fontBl" style="margin-left :40px;"> {{$dateDue[2] }}</span>
                  <br> <span class="fontBl"  style="margin-left : 130px;">{{ @$data->DateDue_Con != NULL ? date_format(date_create(@$data->DateDue_Con),'d') : ' ' }}</span> </td>
            </tr>
            <tr align="">
            ...
            <tr align=""  style="line-height:0.4cm">
              ...
              @endphp
              <td   colspan="2" ><span class="fontBl" style="margin-left : 500px;">{{@$Land_Id}} </span>
             <br/>
