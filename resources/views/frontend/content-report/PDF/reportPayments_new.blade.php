        ...
        <table  border="0"  >
          <tbody>
            ...
            <tr>
              ...
              @endphp
              <th width="120px">
                ดอกเบี้ย (Effective Rate)
              </th>
              <th width="180px" align="right">  {{--number_format(@$data->ContractToCal->Interest_Car,3)--}}
            ...
            <tr>
              ...
              <th width="150px" align="right">
                @if(Str::upper(@$data->ContractToCal->Buy_PA) =="YES")
                  {{@$data->ContractToCal->DataCalcuToPA->Plan_Insur."   คุ้มครอง ".number_format(@$data->ContractToCal->DataCalcuToPA->Limit_Insur)}}  บาท
                @endif
                </th>
            </tr>
