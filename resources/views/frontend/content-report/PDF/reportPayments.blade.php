        ...
        <table border="0"  style="font-size: 11px">
          <tbody>
            ...
            <tr>
              ...
              <th width="80px" rowspan="4">
                <img height="55" src="{{ getcwd().'/cache_barcode/'.$NamepathQr.'.svg' }}" alt="qrcode">
              </th>
              <th width="180px" >
            ...
            <tr style="line-height:5px;font-size:8px;vertical-align:bottom;">
              <th width="235px" align="left">
              </th>
              <th width=""align="center"  >
                <img  height="25" width="225" src="{{ getcwd().'/cache_barcode/'.$NamepathBr.'.png' }}" alt="barcode"   />
                <div>{{$Bar}}</div>
              </th>
            </tr>
          </tbody>
        ...
        <table  border="0"  >
          <tbody>
            ...
            <tr>
              <th width="280px">
                ฝ่ายหนึ่ง กับ &nbsp;&nbsp;&nbsp;<b>
                    {{@$data->ContractToCus->PrefixOther == NULL ? @$data->ContractToCus->Prefix." ".@$data->ContractToCus->Firstname_Cus." ".@$data->ContractToCus->Surname_Cus : @$data->ContractToCus->PrefixOther." ".@$data->ContractToCus->Firstname_Cus." ".@$data->ContractToCus->Surname_Cus}}
                </b>
              </th>
              <th width="">
            ...
            @php
              $asset = @$data->ContractToIndentureAsset2[0]->IndenAssetToDataOwner;
              if(!empty($asset)){
                ...
                if(@$asset->OwnershipToAsset->TypeAsset_Code == "land"){
                  ...
                  $typeAsset = @$asset->OwnershipToAsset->DataAssetToRateType->nametype_car;
                    if($asset->OwnershipToAsset->Vehicle_NewLicense != NULL && strlen($asset->OwnershipToAsset->Vehicle_NewLicense) > 3){
            ...
            <tr>
              ...
              <th width="130px" align="right">
                    ...
                    {{number_format((floatval(@$data->ContractToCal->Cash_Car)+floatval(@$data->ContractToCal->StatusProcess_Car=='yes'? @$data->ContractToCal->Process_Car:0)+floatval(@$data->ContractToCal->Insurance)+floatval(@$data->ContractToCal->Insurance_PA)),2)}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; บาท
                    @elseif( @$data->ContractToCal->Buy_PA == "yes" && @$data->ContractToCal->Include_PA == "no" )
                    {{-- ซื้อประกัน และ ไม่รวมประกันในยอดจัด --}}

                    {{number_format((floatval(@$data->ContractToCal->Cash_Car)+floatval(@$data->ContractToCal->StatusProcess_Car=='yes'? @$data->ContractToCal->Process_Car:0)+floatval(@$data->ContractToCal->Insurance)),2)}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; บาท
                    @elseif( @$data->ContractToCal->Buy_PA == "no" && @$data->ContractToCal->Include_PA == "no" )
                    {{number_format((floatval(@$data->ContractToCal->Cash_Car)+floatval(@$data->ContractToCal->StatusProcess_Car=='yes'? @$data->ContractToCal->Process_Car:0)),2)}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; บาท
                    @else
            ...
            <tr>
              ...
              <th width="130px" align="right">
                {{number_format(@$data->ConstoCarDetails->Process_car,2)}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; บาท
              </th> --}}
            </tr>
            <tr>
              <th width="150px" >
              ...
              $loanCode = ['08', '09', '10', '18', '16'];
                 if ($data->ContractToTypeLoan->Loan_Com == 1) {
                     ...
                     $totalRate = floatval(@$data->ContractToCal->Cash_Car) + floatval(@$data->ContractToCal->StatusProcess_Car=='yes'? @$data->ContractToCal->Process_Car:0) + floatval(@$data->ContractToCal->Insurance) + floatval(@$data->ContractToCal->Insurance_PA);
             ...
             @endphp
              ...
              <th width="130px" align="right">{{--number_format($irrYear/12,4)--}}
                {{number_format(@$data->ContractToCal->Interest_Car,3)}}% &nbsp;&nbsp; ต่อเดือน
              </th>
            </tr>
            <tr>
              <th width="50px" >
            ...
            <tr>
              ...
              <th width="130px" align="right">
                @if(@$data->ContractToCal->Buy_PA=="yes")
