...
@section('content')
    ...
    {{-- <div class="row">
		<div class="col-xl-2 col-lg-2 col-md-3 py-2 shadow-sm d-none d-sm-none d-md-block">
            <div class="row g-2">
                <div class="col-12">
                    <div class="d-grid gap-2">        
                        <button type="button" class="btn btn-soft-warning btn-rounded waves-effect waves-light data-modal-xl-2" data-bs-toggle="modal" data-bs-target="#modal_xl_2" data-link="{{ route('ControlCenter.create') }}?type={{1}}&zone={{Auth::user()->zone}}&FlagPage=Y">
                            <i class="bx bx-calculator bx-tada font-size-16 align-middle"></i> คำนวณ
                        </button>
                    </div>
                </div>
		...
		<div class="col-xl-10 col-lg-10 col-md-9 py-2">
			<div class="tab-content" id="v-pills-tabContent">
				@component('components.content-page.welcome-select')
					@slot('title')
						ข้อมูลลูกค้า
