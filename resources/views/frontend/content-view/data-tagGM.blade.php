        ...
        <tbody>
            @foreach ($dataCus as $row)
                <tr>
                    ...
                    <td class="">
                        <i class="btn btn-soft-danger btn-sm rounded-pill fas fa-user"></i>
                        {{ @$row->successorID->name }}
                    </td>
                    <td class="">
                        <ul class="list-inline font-size-20 contact-links mb-0">
                            <li class="list-inline-item ">
                                <a data-link="{{ route('cus.show', @$row->id) }}?funs={{ 'view-tagparts' }}" title="ข้อมูลการติดตาม" class="data-modal-xl"><i class="bx bx-message-alt-dots hover-up text-info bg-soft"></i></a>
                            </li>
                            <li class="list-inline-item">
