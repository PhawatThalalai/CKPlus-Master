...
<div class="modal-content">
    <div class="d-flex m-3">
        ...
        <div class="flex-grow-1 overflow-hidden">
            <h5 class="text-primary fw-semibold">ดูข้อมูลผู้รับเงิน (Payee Detail)</h5>
            <p class="text-muted mt-n1 fw-semibold font-size-12">No. : {{ @$data->PayeetoCus->IDCard_cus }}</p>
    ...
    <div class="modal-body">
        ...
        @slot('data',[
            'title-general' => 'ข้อมูลทั้วไป (Payee General)',
            'title-address' => 'ข้อมูลที่อยู่ผู้รับเงิน (Payee Address)',
            'data' => @$data->PayeetoCus
        ])
        @endcomponent
    </div>
