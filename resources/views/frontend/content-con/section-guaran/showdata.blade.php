...
<div class="modal-content">
    <div class="d-flex m-3">
        ...
        <div class="flex-grow-1 overflow-hidden">
            <h5 class="text-primary fw-semibold">ดูข้อมูลผู้ค้ำประกัน (Guarantor Detail)</h5>
    ...
    <div class="modal-body">
        ...
        @slot('data',[
            'title-general' => 'ข้อมูลทั้วไป (Guarantor General)',
            'title-address' => 'ข้อมูลที่อยู่ผู้แนะนำ (Guarantor Address)',
            'data' => @$data->GuarantorToGuarantorCus
        ])  
        @endcomponent
    </div>
