...
@slot('data', [
    ...
    'Date_con' => @$data->Date_monetary ? @$data->Date_monetary : $data->Date_con, //วันทำสัญญา
    ...
    'image' => $data->ContractToCus->image_cus, //รูปภาพ
    'typeCus' => @$data->ContractToDataCusTags->TagToStatusCus->Name_Cus, //ประเภทลูกค้า
    'typeCusRe' => @$data->ContractToDataCusTags->TagToTypeCusRe->Name_CusResource, //แหล่งที่มา
    ...
    'Adds_Con' => @$data->ContractToAddress->DataCusAddsToTypeAdds->Name_Address, // ที่อยู่ใช้ทำสัญญา
    'cardProfile' => true
]);
@endcomponent
