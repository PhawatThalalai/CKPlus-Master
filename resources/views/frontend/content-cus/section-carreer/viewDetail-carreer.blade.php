                            ...
                            <div class="row mb-1">
                                <div class="col-12">
                                    <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                        <input class="form-check-input" type="checkbox" name="SwitchStatus_Cus" id="SwitchStatus_Cus" {{@$data->Status_Cus == 'active' ? 'checked' : ''}} disabled>
                                        ...
                                        <input type="hidden" value="{{@$data->Status_Cus}}" name="Status_Cus" id="Status_Cus" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
					...
					<div class="row mx-auto ">
							...
							<div class="row mb-1">
								<div class="col-sm-12">
									<div class="form-floating mb-0">
										<select name="Main_Career" class="form-control form-control-sm textSize-13 border" disabled>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="row mb-1">
								<div class="col-sm-12">
									<div class="form-floating mb-0 ">
										<select name="Career_Cus" id="Career_Cus" class="form-control form-control-sm textSize-13" disabled>
										...
										<label for="Name_Cus" class="fw-bold text-danger">อาชีพ</label>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="row mb-1 g-2">
								<div class="col-sm-12">
									<div class="form-floating mb-0">
										<input type="text" class="form-control" name="Income_Cus" value="{{@$data->Income_Cus}}"  data-bs-toggle="tooltip" title="ประเภทที่อยู่" placeholder="ประเภทที่อยู่" disabled>
										<label for="Name_Cus" class="fw-bold text-danger">รายได้</label>
									</div>
								</div>
                                <div class="col-sm-12">
                                    <div class="form-floating mb-0">
                                        <input type="text" class="form-control" name="BeforeIncome_Cus" value="{{@$data->BeforeIncome_Cus}}" data-bs-toggle="tooltip" title="ชื่อ-นามสกุล" placeholder="ชื่อ-นามสกุล" disabled>
                                        <label for="Name_Cus" class="fw-bold text-danger">หักค่าใช้จ่าย</label>
                                    </div>
                                </div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="row mb-1 g-2">
								<div class="col-sm-12">
									<div class="form-floating mb-0">
										<input type="text" class="form-control" name="AfterIncome_Cus" value="{{@$data->AfterIncome_Cus}}" data-bs-toggle="tooltip" title="ชื่อ-นามสกุล" placeholder="ชื่อ-นามสกุล" disabled>
										<label for="Name_Cus" class="fw-bold text-danger">คงเหลือ</label>
									</div>
								</div>
                                <div class="col-12">
                                    <div class="form-floating mb-0">
                                        <input type="text" class="form-control" name="Workplace_Cus" value="{{@$data->Workplace_Cus}}" value="{{@$data->Workplace_Cus}}" data-bs-toggle="tooltip" title="ชื่อ-นามสกุล" placeholder="ชื่อ-นามสกุล" disabled>
                                        <label for="Name_Cus" class="fw-bold text-danger">สถานที่ทำงาน</label>
                                    </div>
                                </div>
							</div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="row mb-1">
								<div class="col-12">
									<div class="form-floating mb-0">
										<textarea rows="2" name="IncomeNote_Cus" class="form-control form-control-sm textSize-13" disabled>{{@$data->IncomeNote_Cus}}</textarea>
                                        <label for="Name_Cus" class="fw-bold text-danger">หมายเหตุ</label>
