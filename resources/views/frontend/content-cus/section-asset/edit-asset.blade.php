	...
	@csrf
		...
		<div class="d-flex m-3">
			...
			<div class="flex-grow-1 overflow-hidden">
				<h5 class="text-primary fw-semibold">แก้ไขทรัพย์ค้ำประกัน (Edit Assets)</h5>
					...
					<div class="row mx-auto ">
						...
						<div class="col-lg-6 col-md-12">
							<div class="row mb-1 g-1">
								<div class="col-sm-6">
									<div class="form-floating mb-0 ">
										<input type="text" class="form-control " name="Deednumber_Asset" value="{{@$data->Deednumber_Asset}}" data-bs-toggle="tooltip" title="บ้านเลขที่" placeholder="บ้านเลขที่">
										<label for="Name_Cus" class="fw-bold text-danger">เลขที่โฉนด</label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-floating mb-0">
										<input type="text" class="form-control" name="Area_Asset" value="{{@$data->Area_Asset}}" data-bs-toggle="tooltip" title="หมู่" placeholder="หมู่">
                  ...
                  @endforeach
						...
						<div class="col-lg-6 col-md-12">
							<div class="row mb-1">
								...
								<div class="col-sm-12">
									<div class="form-floating mb-0">
										<input type="text" class="form-control Postal" id="Postal_Asset" name="Postal_Asset" value="{{@$data->Postal_Asset}}" placeholder="ชื่อ-นามสกุล" autocomplete="off">
		...
		<div class="modal-footer">
			<button type="button" id="btn_EditAsset" class="btn btn-primary btn-sm waves-effect waves-light hover-up ">
