...
class CreateDataRateInterestP03STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_rateInterest_P03s', function (Blueprint $table) {
            $table->integer('id');
            $table->primary('id');
    ...
    {
        Schema::dropIfExists('data_rateInterest_P03s');
    }
}
