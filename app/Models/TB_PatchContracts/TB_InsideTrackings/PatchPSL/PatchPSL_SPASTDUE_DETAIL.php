...
class PatchPSL_SPASTDUE_DETAIL extends Model
{
    use HasFactory,SoftDeletes;

    protected $table = 'PatchPSL_SPASTDUE_DETAIL';
    ...
    {
        return $this->belongsTo(PatchPSL_SPASTDUE::class,'SPASTDUE_ID','id');
    }

    public function ToAREA()
    {
        return $this->hasOne(PatchPSL_SPASTDUE_AREA::class,'DETAIL_ID','id');
    }
