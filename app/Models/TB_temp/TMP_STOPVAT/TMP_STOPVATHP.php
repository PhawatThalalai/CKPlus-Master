...
class TMP_STOPVATHP extends Model
{
    use SoftDeletes;

    protected $table = "TMP_STOPVATHP";
    protected $fillable = [
        "PatchCon_id", "dataPact_id", "LOCAT", "CONTNO", "CUSCOD",
        "SDATE", "STOPVDT", "STOPVFL", "TOTPRC", "EXP_PRD", "EXP_FRM",
        "EXP_TO", "EXP_AMT", "USERSTOPV", "INPDATE", "GRDCOD", "UserInsert",
        "UserBranch", "UserZone",
    ];
